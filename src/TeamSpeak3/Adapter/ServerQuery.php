...
class ServerQuery extends Adapter
{
  ...
  {
    $query = Str::factory($cmd)->section(TeamSpeak3::SEPARATOR_CELL);
    ...
    {
      throw new Exception("command not found", 0x100);
    }
    ...
    do {
      ...
      $rpl[] = $str;
    } while($str instanceof Str && $str->section(TeamSpeak3::SEPARATOR_CELL) != TeamSpeak3::ERROR);
